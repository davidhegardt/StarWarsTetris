...
namespace Tetris
{
    public class Type2 : Block
    {
        public string blockType = "Type2";
        /*
        *       X
        *      XXX
        */
        ...
        public Type2()
        {
            ...
            colValues.Add(5); colValues.Add(4); colValues.Add(5); colValues.Add(6);
            rowValues.Add(1); rowValues.Add(2); rowValues.Add(2); rowValues.Add(2);
            setupNext();
        }
        ...
        private void leftRotate()
        {
            // block 1
                    // == 5,1    1
            rows[1] = rows[1] - 2;        // == 4,2    2
            cols[2] =cols[2] - 1; rows[2] = rows[2] - 1;        // == 5,2    3
            cols[3] = cols[3] - 2;        // == 6,2    4
        }

        private void upRotate()
        {
            rows[1] = rows[1]; cols[1] = cols[1] + 2;
        ...
        private void setupNext()
        {
            ...
            colValuesNext.Add(3); colValuesNext.Add(2); colValuesNext.Add(3); colValuesNext.Add(4);
            rowValuesNext.Add(1); rowValuesNext.Add(2); rowValuesNext.Add(2); rowValuesNext.Add(2);
        }
    }
}
